...
\fitfivegraphics{step_note_full.png}{step_chord_full.png}{step_euclid_full.png}{step_cc_full.png}{step_fx_full.png}
...
If you want to edit the velocity for a row of steps, hold \btncolor{pygreen}{velocity}, press the first step together with the last step of the row \stepbystepselectionicon{} and rotate \encodericon{}.

\tip{Double tap a step-by-step pad \stepbystepicon{} to add a low velocity note in order to create accents quickly.}
...
You can also edit the width of several steps: hold \btncolor{pygreen}{note width}, press the first step together with the last step of the row \stepbystepselectionicon{} and rotate \encodericon{}.
...
You can edit the offset of several steps: hold \btncolor{pygreen}{offset}, press the first together with the last step of the row \stepbystepselectionicon{} and rotate \encodericon{}.
...
\tip{You can also transpose a row of steps \stepbystepselectionicon{}, by pressing the first and last step, and rotating \encodericon{}.}
...
Turn \encodericon{} to change the triggered note (for example \textbf{C3\sharp}) and use \btncolor{pygreen}{note width} to change the gate.

Press \btn{DISP} to view the Euclidean circle:

\fitgraphics{EUCLID.png}

\tip{The filled steps are also displayed on the pads. You can press a pad \stepbystepicon{} to add or remove steps and thus create your own pattern.}
...
\tip{You can also increase or decrease a row of steps \stepbystepselectionicon{}, by pressing the first and last step, and rotating \encodericon{}.}
...
Press \blackbtn{2ND} + \blackbtn{copy} + any step \stepbystepicon{} to copy all the notes or automations contained in a step.

You can copy multiple steps by pressing  \blackbtn{2ND} + \blackbtn{copy} + the first and the last steps \stepbystepselectionicon{} of your selection.

Then you can paste notes and automations in the current track or in another track. Press  \blackbtn{2ND} + \blackbtn{paste} + the step \stepbystepicon{}.
...
Press \blackbtn{2ND} + \blackbtn{delete} + any step \stepbystepicon{} to delete all the notes contained in the step.
