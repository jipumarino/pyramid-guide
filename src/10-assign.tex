...
Disable \btn{rec} to fix the automation:
...
Hold \btn{ASSIGN} and plug a mini jack on the input you want to assign (CV input or GATE input), the assign manager display will appear. Then select the CC message or the FX you want to assign. Moreover, the option ``CV IN MODE'' in \btn{SETTINGS} will be autoset to CC MESSG, instead of CV/GATE.
