...
PERFORM: launch your sequences on the fly. You can select the delay Pyramid will wait until playing the next sequence (Instant, 1 Beat, 1 Bar, 2 Bar, ... 8 Bar). It's a great creative tool to improvise your song with a total freedom, but always in sync!
...
\fithalfgraphics{RELATCH.png}
\fithalfgraphics{TRIG.png}
