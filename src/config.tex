...
\newcommand{\btncolor}[2]{\tcbox[top=0pt,bottom=0pt,left=1pt,right=1pt,arc=0.5pt,boxsep=0pt,colframe=#1,colback=#1,nobeforeafter,tcbox raise base]{#2}}
\newcommand{\btn}[1]{\IfStrEqCase{#1}{{step}{\btncolor{pygreen}{STEP}}{live}{\btncolor{pyred}{LIVE}}{seq}{\btncolor{pyblue}{SEQ}}{track}{\btncolor{pyyellow}{TRACK}}{rec}{rec~\includegraphics[height=\fontcharht\font`\B]{figs/rec.pdf}}}[\btncolor{pygray}{#1}]}
\newcommand{\btni}[1]{\btn{#1}}

\newcommand{\note}[1]{\textit{#1}}

\newcommand{\tip}[1]{\btncolor{tipblue}{\textcolor{white}{TIP}} #1}
...
% - notes are sometimes captions really
% - "tip" in smaller font
% - \ldots instead of … and ...
...
% - consider changing textbf to a more descriptive macro like \pymode{}
...
\newcommand{\fithalfgraphics}[1]{\begin{figure}[H]\centering\includegraphics[max width=0.5\columnwidth]{figs/#1}\end{figure}}

\newcommand{\fitthirdgraphics}[1]{\begin{figure}[H]\centering\includegraphics[max width=0.333333\columnwidth]{figs/#1}\end{figure}}
