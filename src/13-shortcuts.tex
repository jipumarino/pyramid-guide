...
In stepmode \btn{NOTE}, you can display the parameters of a step. Hold \btncolor{pygreen}{velocity} and press a filled step to display (and even edit) the step velocity. Same behaviour for \btncolor{pygreen}{length} and \btncolor{pygreen}{width}. You can also display and edit several steps: hold \btncolor{pygreen}{velocity} (or \btncolor{pygreen}{length} or \btncolor{pygreen}{width}) and press the first step together with the last step of the row \stepbystepicon{}.
