...
\subsection{How to select the current track}
...
Regardless the mode you are using, hold \btni{TRACK} and select the track of the current BANK you want to work on with one of the 16 pads \stepbystepicon{} (for example TR03A).
...
\subsection{How to capture a performance}
...
Regardless the mode you are using, hold \btni{SEQ} and select the sequence you want to work on with one of the 16 pads \stepbystepicon{}. If you select an empty sequence, the track mute states of the last sequence will be applied to this new sequence.
...
Holding \btni{SEQ} and select the sequence will play the new selected sequence without waiting for the end of the currently playing sequence (instant jump). If you want to launch a new sequence after the end of the current sequence measure, enter the \btn{SEQ} mode and press one of the 16 pads \stepbystepicon{} (without holding \btn{SEQ}).
...
\fittwobytwographics{zoom100.png}{midichannel.png}{signature44.png}{bar64.png}
